...
const navLinks = document.querySelectorAll(".nab-mobile .list-link");
...
sr.reveal(
  `.image-left, .popular-destinations-date,
  .plane-trip-date`,
  {
    origin: "left",
  }
...
sr.reveal(`.image-right, .showcase-date`, {
  origin: "right",
});

sr.reveal(".bach-date-wrapper", {
  origin: "bottom",
  interval: 250,
});
